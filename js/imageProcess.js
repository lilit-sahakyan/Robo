...
export function draw2D(type, image) {
  let skin = new Image();
  ...
  skin.addEventListener("load", () => {
    ...
    img.addEventListener("load", () => {
      if (type == "shirt") {
        draw(img, skin, 231, 74, 231 + 128, 74 + 128, 168, 69, (skin) => {
          draw(img, skin, 217, 355, 217 + 64, 355 + 128, 104, 69, (skin) => {
            draw(img, skin, 308, 355, 308 + 64, 355 + 128, 296, 69, (skin) => {
              draw(img, skin, 427, 74, 427 + 128, 74 + 128, 453, 69, (skin) => {
                draw(
                  img,
                  skin,
                  85,
          ...
          draw(img, skin, 231, 74, 231 + 128, 74 + 128, 168, 69, (skin) => {
            draw(img, skin, 217, 355, 217 + 64, 355 + 128, 104 + 64, 197, (skin) => {
              draw(
                img,
                skin,
                308,
